...
funfacts = [
  ...
  "The full Moon takes up the same amount of space in the sky as our nearest spiral galaxy neighbor (which is very faint).",
  ...
  "If you could place a pinhead-sized piece of the Sun on the Earth you would die from standing within 145 km (90 miles) from it.",
  ...
  "The pistol star is the most luminous star known, at 10 million times the brightness of the Sun.",
  ...
  "8000 stars are visible with the naked eye from Earth. 4000 in each hemisphere, 2000 at daylight and 2000 at night.",
  ...
  "Lunar eclipses can last 1 hour and 40 minutes.",
  "All the coal, oil, gas, wood and fuel on Earth would only keep the Sun burning for few days.",
  "A full moon is nine times brighter than a half moon.",
  "When the Moon is directly above your head or if you stand at the equator, you weigh slightly less.",
  ...
  "Every year, the Moon moves away from Earth by 3.8 centimeters.",
  ...
  "Upsilon Andromeda B only faces one side to its star. One side is hot as lava while the other one is cold, below freezing.",
  ...
  "Ice evaporates in space the same way it does when you leave ice cubes in your freezer for a long time. It's called sublimation.",
  "“Twinkle, Twinkle, Little Star” is a fairly accurate description of a type of star called a white dwarf, made of compressed carbon.",
  "Quasars are some of the most luminous objects in the Universe. Each is powered by a supermassive black hole.",
  "Material falling into a black hole can radiate a lot of energy before it crosses the event horizon, after which it can't escape.",
  "If you fell into a black hole you wouldn't be crushed: you'd be stretched to death by tidal forces. It'd still be gross.",
  "If you wanted to become a black hole, you'd have to compress yourself smaller than an atom, and you would evaporate immediately.",
  "Dark matter only feels and exerts gravity. There's dark matter passing through your body right now, but you can't feel it.",
  "Galaxies come in all shapes and sizes. You'd need a billion of the smallest galaxies to match the star count in the biggest one."
]
